    ...
    <div class="container Font_General">
        <div class="forms-container">
            <div class="signin-signup">
                <form action="" class="sign-in-form" name="formResetPassword" id="formResetPassword">
                    ...
                    <div class="input-field">
                        ...
                        <input type="password" placeholder="Verify Password" name="password_confirm" id="password_confirm" required />
                    </div>
                    <button type="submit" class="btn solid"><i class="fas fa-check-circle"></i> Change </button>
                </form>
            </div>
        </div>
