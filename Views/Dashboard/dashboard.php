                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="col-md-12 mb-3">
                            <div class="card shadow h-100 py-2 text-decoration-none text-reset" style="border-left: 10px solid #212A3E">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-uppercase mb-1">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="momento">
                                                <!--Calculo desde js-->
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="Alto">
                                                <!--Calculo desde js-->
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" id="Alergias">
                                                <!--Calculo desde js-->

                                            </div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-head-side-cough fa-2x text-gray-300 dance-icon"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
