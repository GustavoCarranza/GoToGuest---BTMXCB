<!--Agregar lugares-->
<div class="modal fade" id="modalLugar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" style="background: #006179; color:#fff;">
                <h5 class="modal-title"> New place of complaint </h5>
            </div>
            <div class="modal-body">

                <form class="form-horizontal" id="formLugar" name="formLugar">
                    ...
                    <div class="row mb-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="txtDescripcion" name="txtDescripcion" rows="2" placeholder="Description of the location of the complaint" required></textarea>
                        </div>
                    </div>
...
<!--Editar Lugares-->
<div class="modal fade" id="modalUpdateLugar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" style="background: #006179; color:#fff;">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="formLugarUpdate" name="formLugarUpdate">
                    <p class="text-danger">All fields are required</p>

                    <input type="hidden" name="idLugar" id="idLugar" required>
                    ...
                    <div class="row mb-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="txtDescripcionUpdate" name="txtDescripcionUpdate" rows="2" placeholder="Description of the location of the complaint" required></textarea>
                        </div>
                    </div>
