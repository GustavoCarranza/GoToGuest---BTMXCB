<!--Agregar quejas-->
<div class="modal fade" id="modalDepartamentos" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" style="background: #006179; color:#fff;">
                <h5 class="modal-title"> New Department </h5>
                <button type="button" style="border-radius:50px; width:30px; height:30px; border:none;" data-bs-dismiss="modal" aria-label="Close">X</button>
            </div>
            <div class="modal-body">

                <form class="form-horizontal" id="formDepartamento" name="formDepartamento">
                    ...
                    <div class="row mb-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="txtDescripcion" name="txtDescripcion" rows="2" placeholder="Department description" required></textarea>
                        </div>
                    </div>
...
<!--Editar quejas-->
<div class="modal fade" id="modalUpdateDepartamentos" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="formDepartamentosUpdate" name="formDepartamentosUpdate">
                    <p class="text-danger">All fields are required</p>
                    ...
                    <div class="row mb-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="txtDescripcionUpdate" name="txtDescripcionUpdate" rows="2" placeholder="Department description" required></textarea>
                        </div>
                    </div>
